    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header d-flex align-items-center">
                <h5 class="card-title mb-0 flex-grow-1">Lista e Brands</h5>
                <div>
                    <button type="button" class="btn btn-success" id="btn_create">
                        <i class="ri-add-line align-middle me-1"></i> Shto Brand
                    </button>
                </div>
            </div>
            <div class="card-body">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="hstack gap-1">
                                        <!-- Show Button -->
                                        <button type="button"
                                            class="btn btn-sm btn-info" id="modal_show" data-id="{{ $brand->id }}"
                                            title="Shiko">
                                        ...
                                        <!-- Edit Button -->
                                        <button type="button"
                                            class="btn btn-sm btn-primary" id="modal_edit" data-id="{{ $brand->id }}"
                                            title="Modifiko">
                                        ...
                                        <!-- Delete Button -->
                                        <button type="button"
                                            class="btn btn-sm btn-danger" id="modal_delete" data-id="{{ $brand->id }}"
                                            title="Fshij">
...
<script>
    ...
    $(document).on('click', '#modal_edit', function() {
        ...
        fetch('/brands/' + id, {
            ...
            .then(data => {
                modalBody.innerHTML = `
                    <div class="mb-3">
                        <label for="edit_name" class="form-label">Emri i Brand <span class="text-danger">*</span></label>
                        <input type="text"
                            class="form-control"
                            id="edit_name"
                            name="name"
    ...
    $(document).on('click', '#modal_delete', function() {
        ...
        Swal.fire({
            ...
            text: "Ky brand do të fshihet përgjithmonë!",
            icon: 'warning',
