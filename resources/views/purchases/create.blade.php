                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <select class="form-select @error('order_status') is-invalid @enderror" id="order_status"
                                    ...
                                    <option value="Received" {{ old('order_status') == 'Received' ? 'selected' : '' }}>
                                        Received</option>
                        ...
                        <div class="mt-4">
                            ...
                            <textarea class="form-control" id="notes" name="notes" rows="3" placeholder="Shto shënime...">{{ old('notes') }}</textarea>
                        </div>
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.success && response.product) {
                        ...
                        // Close modal
                        bootstrap.Modal.getInstance(document.getElementById('createProductModal'))
                            .hide();
